...
<head>
  ...
  <link rel="stylesheet" href="addhindi.css">
</head>
<body>
  <h1>Upload HINDI Music</h1>
  <div>
...
$sql = "INSERT INTO hindi (title, singer, image_path, music_path) VALUES ('$title', '$singer', '$image_path', '$music_path')";

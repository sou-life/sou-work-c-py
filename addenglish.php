...
<head>
  ...
  <link rel="stylesheet" href="addenglish.css">
</head>
<body>
  <h1>Upload ENGLISH Music</h1>
  <div>
...
$sql = "INSERT INTO english (title, singer, image_path, music_path) VALUES ('$title', '$singer', '$image_path', '$music_path')";
